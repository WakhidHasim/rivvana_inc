@extends('layouts.admin.app', ['title' => 'Edit Service'])
                    ...
                    <form method="POST" action="{{ route('services.update', $service->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('name') is-invalid @enderror" id="name"
                                aria-describedby="nameHelp" name="name" value="{{ old('name', $service->name) }}"
                                autofocus>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            @if ($service->icon)
                                <img src="{{ asset('/storage/services/' . $service->icon) }}"
                                    class="icon-preview img-fluid mb-3 col-sm-6 d-block">
                            @else
